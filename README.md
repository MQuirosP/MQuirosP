...
- 🎨 Diseño responsive y cross-platform (web + mobile)

- 🧪 Buenas prácticas con TDD y testing

- 🐳 Docker y despliegue de apps multiplataforma

- 📱 Desarrollo nativo con Expo y React Native
...
- 🎫 [Bancas Admin App](https://github.com/MQuirosP/bancas-admin-app)  

  Sistema administrativo completo para gestión de loterías. Desarrollado con React Native, Expo, Tamagui, React Query y Zustand. Aplicación cross-platform (web, iOS, Android) con diseño responsive, impresión térmica, generación de códigos de barras y arquitectura escalable.
